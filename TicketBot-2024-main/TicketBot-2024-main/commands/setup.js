        ...
        if (interaction.isButton() && interaction.customId === 'setup_ticket') {
          try {
            ...
            if (ticketChannel) {
              ...
              .setDescription('Cảm Ơn Bạn Đã Sử Dụng Tới Ticket Có Vấn Đề Gì Thì Tạo Ticket Bạn Nhé:**\n' +
                 '- Tạo Đơn Cày Thuê Hoặc Trao Đổi Vấn Đề.\n' +
                 '- Bot By Kaioshinn.'
              .setFooter({ text: 'Cảm Ơn Đã Sử Dụng!', iconURL:'https://cdn.discordapp.com/attachments/1209499496732692580/1209514764531924992/1667-yellow-gears.gif?ex=65e73367&is=65d4be67&hm=10e9c542cab73102272ecb710cb58f11e581d7c6e9bf7d7c9da6217cda3928b9&'});
